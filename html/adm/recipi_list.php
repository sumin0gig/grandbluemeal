	...
	<section id="anc_001">
		...
		<div class="tbl_head01 tbl_wrap">
			...
			<tr>
				...
				<th scope="col" class="bo-left bo-right">도감 분류</th>
				<th scope="col" class="bo-left bo-right">도감 등록</th>
			...
			<tr class="<?php echo $bg; ?>">
				...
				<td style="Text-align: center;">
					<select name="re_dic_cate[<?php echo $i ?>]" id="re_dic_cate_<?php echo $i ?>">
						<option value="요리" <?php echo $row['re_dic_cate'] == "요리" ?"selected":"" ?>>요리</option>
						<option value="도구" <?php echo $row['re_dic_cate'] == "도구" ?"selected":"" ?>>도구</option>
						<option value="기타" <?php echo $row['re_dic_cate'] == "기타" ?"selected":"" ?>>기타</option>
					</select>
				</td>
				<td style="Text-align: center;">
					<input type="checkbox" name="dic_show[<?php echo $i ?>]" value="1" id="dic_show_<?php echo $i ?>" <?php echo $row['dic_show']?"checked":"" ?>>
				</td>
				<td>
				<?
...
<form name="fpointlist2" method="post" id="fpointlist2" action="./recipi_update.php" autocomplete="off">
	...
	<section id="anc_002">
		...
		<div class="tbl_frm01 tbl_wrap">
			...
			<tr>
				<th scope="row"><label for="dic_show">도감 등록</label></th>
				<td><input type="checkbox" name="dic_show" value="1" id="dic_show" /></td>
			</tr>
			<tr>
