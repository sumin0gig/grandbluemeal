...
<section id="anc_002">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			<th scope="row">하루 식사 횟수</th>
			<td>		
				<input type="text" name="cf_eat_count" value="<?php echo get_text($config['cf_eat_count']) ?>" id="cf_eat_count" size="10">
			</td>
		</tr>
		</tbody>
		</table>
...
<section id="anc_003">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			<th scope="row">상점 브랜드</th>
			<td>-</td>
			<td>
				<?php echo help('브랜드 구분은 || 를 사용합니다. ex) 일반||프로필수정||기타') ?>
				<input type="text" name="cf_shop_brand" value="<?php echo get_text($config['cf_shop_brand']) ?>" id="cf_shop_brand" size="100">
			</td>
		</tr>
		<tr>
