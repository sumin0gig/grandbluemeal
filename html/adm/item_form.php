	...
	<div class="tbl_frm01 tbl_wrap">
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row">도감 등록 여부</th>
					<td>
						<input type="checkbox" name="dic_show" id="dic_show" value="1" <?=$item['dic_show']=='1' ? "checked" : ""?> />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<span data-type="식사" class="switch-obj" style="display:<?=strstr($item['it_type'], '식사') ? "inline-block" : "none"?>;">
							경험치:
							<input type="text" name="it_exp" value="<?php echo $item['it_exp']; ?>" id="it_exp" size="15">
							스탯 : 
							<select name="st_id">
								<option value="">지정하지 않음</option>
								<?
				...
				<tr>
					...
					<td colspan="2">
						...
						<input type="checkbox" name="it_use_search" id="it_use_search" value="1" <?=$item['it_use_search']=='1' ? "checked" : ""?> />
						<label for="it_use_search">탐색 재료 사용</label>

						<input type="checkbox" name="it_use_reward" id="it_use_reward" value="1" <?=$item['it_use_reward']=='1' ? "checked" : ""?> />
						<label for="it_use_reward">몬스터 보상 사용</label>
						<?php echo help("&nbsp;") ?>
